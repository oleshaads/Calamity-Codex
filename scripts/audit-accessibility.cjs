...
(async () => {
  ...
  check(prefetch && /codex-data\.min\.js\?v=20260824-core114$/.test(prefetch.href), "Catalog intent did not create the current versioned prefetch hint");
  ...
  check(baguetteSprite?.getAttribute("src") === "assets/item-sprites/Baguette.png?v=20260824-core114", "Catalog still renders a stale unversioned Baguette animation sheet URL");
