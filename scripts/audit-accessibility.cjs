...
(async () => {
  ...
  check(prefetch && /codex-data\.min\.js\?v=20260819-core71$/.test(prefetch.href), "Catalog intent did not create the current versioned prefetch hint");
  ...
  check(baguetteSprite?.getAttribute("src") === "assets/item-sprites/Baguette.png?v=20260819-core71", "Catalog still renders a stale unversioned Baguette animation sheet URL");
