...
window.CALAMITY_MOB_GUIDE = {
  ...
  events: [
    { id: "blood-moon", title: "Кровавая луна", tags: ["e:BloodMoon"], summon: "Случайной ночью (шанс ~1 из 9 при 120+ ОЗ) либо вручную Кровавой слезой.", tip: "Зомби открывают двери — поставь дверь на платформу или закройся блоками. Рыбалка в кровавую луну даёт особых врагов с ценным дропом." },
    ...
    { id: "goblins", title: "Гоблинская армия", tags: ["i:Goblins"], summon: "Шанс с рассвета после разбитой теневой сферы или багряного сердца; вручную — Гоблинское боевое знамя.", tip: "Гоблин-волшебник телепортируется, воины идут толпой. После победы в пещерах появляется Связанный гоблин-изобретатель." },
    ...
    { id: "eclipse", title: "Солнечное затмение", tags: ["e:Eclipse"], summon: "Утром с шансом 1 из 20 после победы над любым механическим боссом; вручную — Солнечная табличка из Храма джунглей.", tip: "После Плантеры появляется Мотрон с Осколками светозара. Дерись у дома: враги ломятся к тебе весь день." },
    { id: "frost-legion", title: "Морозный легион", tags: ["i:FrostLegion"], summon: "Используй Снежный шар (находится в Подарках, выпадающих в декабре/на Рождество).", tip: "Простое событие со снеговиками; после победы Санта-Клаус может заселиться." },
    { id: "pirates", title: "Пиратское вторжение", tags: ["i:Pirates"], summon: "Случайно в хардмоде после разрушенного алтаря; вручную — Пиратская карта (дроп врагов океана в хардмоде).", tip: "Летучий голландец и капитаны приносят аксессуары денег и Симпатичный розовый кулон." },
    { id: "old-ones", title: "Армия Старика", tags: ["i:OldOnesArmy"], summon: "Купи у Трактирщика Подставку Этернии и Кристалл Этернии, установи и активируй кристалл.", tip: "Защищай кристалл башнями Этернии. Три уровня сложности открываются по прогрессии (до механических, после них и после Голема)." },
    ...
    { id: "pumpkin-moon", title: "Тыквенная луна", tags: ["i:PumpkinMoon"], summon: "Используй Тыквенный медальон ночью (тыквы + эктоплазма + святые слитки).", tip: "15 волн до рассвета. Строй арену с ловушками и хилками: на поздних волнах идут Тыквенный король и Мрачный жнец." },
    { id: "frost-moon", title: "Морозная луна", tags: ["i:FrostMoon"], summon: "Используй Гадкий подарок ночью (шёлк + эктоплазма).", tip: "20 волн; Ледяная королева и Санта-танк на поздних. Одно из лучших испытаний DPS в игре." },
    { id: "pillars", title: "Лунные столпы", tags: ["b:SolarPillar", "b:NebulaPillar", "b:VortexPillar", "b:StardustPillar"], summon: "Появляются автоматически после победы над Лунатиком-культистом — четыре столпа в разных частях мира.", tip: "Убей ~100 врагов у столпа, чтобы снять щит. После четырёх столпов через минуту приходит Лунный лорд." },
    { id: "acid-rain", title: "Кислотный дождь · Calamity", tags: ["ce:AcidRain"], summon: "Начинается случайно после Глаза Ктулху; вторая стадия — после Водного бича, третья — после Полтергаста. Вручную — Каустическая слеза.", tip: "Идёт в Сернистом море. В финале третьей стадии появляется Старый герцог. Дроп: осколки серы и радиоактивные материалы." }
  ],
  biomes: [
